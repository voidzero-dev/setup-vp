...
import { isWithin, resolvePath } from "./project.js";
import { createLockfileResolver } from "./lockfile-version.js";
...
export function createVersionResolver(context: ResolutionContext) {
   ...
   *   5. "latest"
   */
  function resolveVitePlusVersion(inputs: Inputs, projectDir: string): string {
   ...
   * ranges.
   */
  function resolveVitePlusVersionFile(filePath: string, baseDir?: string): string {
   ...
   */
  function tryResolveVitePlusVersionFile(filePath: string, baseDir?: string): string | undefined {
    try {
   ...
   */
  function tryResolveVitePlusVersionFromProject(projectDir: string): string | undefined {
    try {
